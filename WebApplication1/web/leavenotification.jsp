    ...
    <table class="table table-bordered w-50 m-5">
        <form action="leave.jsp" method="post">
            <thead class="thead-dark">
                <tr>
                    <th class="text-center" colspan="2">Leave Notification</th>
                </tr>
            </thead>
            <%
         ...
         %>
           <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="date" name="date" class="p-1 w-100" required>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="reason" class="p-1 w-100" required>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <textarea name="sugg" class="w-100" required></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
