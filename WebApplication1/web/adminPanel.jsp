...
<body>
    <nav class="navbar p-0 navbar-expand-lg .navbar-custom navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto ">
            <li class="nav-item active p-1">
              <a class="nav-link" href="#">Upload Classroom</a>
            </li>
            <li class="nav-item p-1">
                <a class="nav-link" href="uploadtimetable.jsp">Upload Time Table</a>
              </li>
            <li class="nav-item p-1">
      ...
      <div class="border rounded box-shadow center w-50 mt-2">
        <div class="header">
         <h3 class="text-right text-white py-5 px-3">Upload ClassRoom <br/> Availability</h3>
        </div>
       <form action="classroom.jsp" method="post" class="d-flex flex-column p-3">
